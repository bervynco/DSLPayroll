...
public class FilterReports extends javax.swing.JFrame {

    /**
     * Creates new form FilterReports
     */
    ...
    public FilterReports(User user, ArrayList<String> employeePages) throws SQLException, ClassNotFoundException, ParseException{
                ...
                try {
                    if(name.equals("All")){
                        try {
                            ...
                            Logger.getLogger(FilterReports.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    Main menu = new Main( this.sessionUser, employeePages, "Reports");
